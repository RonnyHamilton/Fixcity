...
import { ArrowLeft, Eye, EyeOff, Loader2, ShieldCheck, Wrench, Lock } from 'lucide-react';
    ...
    const handleLogin = async () => {
        ...
        try {
            const response = await fetch('/api/auth/technician-login', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ badgeId: techId, password, faceVerified }),
            });
                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[11px] font-semibold uppercase tracking-wide text-[#166534]">Technician Portal</span>
                        </div>
                    </div>
            ...
            <main className="flex-1 flex items-center justify-center px-6 py-12">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        {/* Card Header */}
                        <div className="bg-gradient-to-r from-[#166534] to-[#22c55e] px-8 py-6 text-center">
                            <h1 className="text-xl font-bold text-white">Technician Authentication</h1>
                            <p className="text-green-100 text-sm mt-1">Secure identity verification required</p>
                        </div>
                        ...
                        <div className="p-8">
                            ...
                            <div className="mb-8">
                                <div className="flex items-center gap-2 mb-4">
                                    <div className="w-6 h-6 rounded-full bg-[#166534] text-white text-xs font-bold flex items-center justify-center">1</div>
                                ...
                                <div className="flex flex-col items-center">
                                            ...
                                            <div className="w-full h-full rounded-full overflow-hidden bg-slate-100 relative">
                                                ...
                                                {cameraActive && scanning && (
                                                    <div className="absolute inset-0 pointer-events-none">
                                                        <div className="absolute inset-0 bg-[#166534]/10" />
                                                        <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#166534] animate-[scan_2s_ease-in-out_infinite]" />
                                                    </div>
                                                )}
                                    ...
                                    {!faceVerified && (
                                        <button
                                            ...
                                            disabled={scanning}
                                            className="mt-4 px-6 py-2.5 bg-[#166534] hover:bg-[#14532d] text-white text-sm font-semibold rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            {scanning ? (
                            ...
                            <div className="mb-6">
                                <div className="flex items-center gap-2 mb-4">
                                    <div className="w-6 h-6 rounded-full bg-[#166534] text-white text-xs font-bold flex items-center justify-center">2</div>
                                ...
                                <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }} className="space-y-4">
                                    {/* Technician ID */}
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2">Technician ID</label>
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full h-12 rounded-lg border border-slate-300 bg-white pl-12 pr-4 text-sm text-slate-900 placeholder-slate-400 focus:border-[#166534] focus:ring-2 focus:ring-[#166534]/20 focus:outline-none transition-all"
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full h-12 rounded-lg border border-slate-300 bg-white pl-12 pr-12 text-sm text-slate-900 placeholder-slate-400 focus:border-[#166534] focus:ring-2 focus:ring-[#166534]/20 focus:outline-none transition-all"
                                    ...
                                    <button
                                        ...
                                        className="w-full h-12 bg-[#166534] hover:bg-[#14532d] text-white rounded-lg font-semibold text-sm transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {loading ? (
