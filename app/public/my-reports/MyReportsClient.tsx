...
import { FileText, Clock, CheckCircle, AlertCircle, ChevronRight, Plus, X, MapPin, Calendar, Tag, Trash2, Phone, BadgeCheck, TrendingUp } from 'lucide-react';
        ...
        <div className="px-4 sm:px-6 py-8 mx-auto w-full max-w-[1024px]">
                ...
                <div className="space-y-4">
                    {filteredReports.map((report) => {
                        ...
                        return (
                            <div
                                key={report.id}
                                className="bg-white rounded-xl border border-slate-100 shadow-sm p-4 md:p-6 flex flex-col md:flex-row gap-4 hover:shadow-md transition-all group"
                            >
                                {/* Image */}
                                <div className="w-full md:w-32 h-32 md:h-24 flex-shrink-0 rounded-lg overflow-hidden bg-slate-100">
                                    {report.image_url ? (
                                        <img
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex flex-wrap items-start gap-2 mb-2">
                                        ...
                                        <span className={`text-xs font-medium px-2 py-0.5 rounded ${report.priority === 'urgent' ? 'bg-red-50 text-red-600' :
                                    ...
                                    <p className="text-slate-800 font-medium mb-1 line-clamp-1">{report.description}</p>
                                    <p className="text-slate-500 text-sm mb-2 line-clamp-1">{report.address}</p>
                                    ...
                                    <div className="flex flex-wrap items-center gap-4 text-xs text-slate-400">
                                        ...
                                        {report.assigned_technician_id && (
                                            <span className="text-green-600">Technician Assigned</span>
                                        )}
                                    </div>
                                    ...
                                    {report.resolution_notes && (() => {
                                        ...
                                        return (
                                            <div className="mt-3 p-3 bg-green-50 border border-green-100 rounded-lg space-y-2">
                                                <p className="text-green-700 text-sm font-medium">Resolution Notes:</p>
                                ...
                                <div className="flex md:flex-col items-center md:items-end justify-between md:justify-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-1 text-blue-600 text-sm font-medium hover:underline group-hover:gap-2 transition-all"
                                    >
                                        View Details
            ...
            {selectedReport && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    />
                    <div className="relative bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        <button
                            onClick={() => setSelectedReport(null)}
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-800 font-mono">{selectedReport.id}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-800">{selectedReport.address}</p>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-slate-800 text-sm">{formatDate(selectedReport.created_at)}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-slate-800 text-sm">{formatDate(selectedReport.updated_at)}</p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="bg-white rounded-xl p-4">
                                            ...
                                            <div className="flex items-center justify-between bg-slate-50 p-3 rounded-lg border border-slate-100">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-slate-800 font-bold">{assignedTechnician.name}</p>
                            ...
                            <div className="mt-8 flex gap-3">
                                ...
                                {selectedReport.status === 'pending' && (
                                    <button
                                        ...
                                        className="flex-1 py-3 bg-red-50 hover:bg-red-100 border border-red-100 text-red-600 font-bold rounded-xl transition-colors flex items-center justify-center gap-2"
                                    >
            ...
            {deletingReportId && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
                        ...
                        <div className="mb-6">
                            <label className="text-xs font-bold text-slate-500 uppercase mb-1 block">Reason for Deletion <span className="text-red-500">*</span></label>
                            <textarea
                                value={deletionReason}
                                onChange={(e) => setDeletionReason(e.target.value)}
                                className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-slate-800 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none h-24 resize-none placeholder:text-slate-400"
